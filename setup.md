...
> Es wurde ein automatisches Setup-Skript namens `setup.sh` erstellt, das alle unten beschriebenen Schritte (mdBook, Docker, Judge0 mit cgroup-Fix und Anki) vollautomatisch für dich ausführt.
